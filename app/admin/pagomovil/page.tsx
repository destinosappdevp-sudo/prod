...
async function getNotificaciones() {
  ...
  try {
    ...
    return { data: notificaciones as any[], error: null };
  } catch (e) {
...
export default async function PagomovilPage() {
  const { data: notificaciones, error } = await getNotificaciones();
    ...
    <div className="space-y-6">
      ...
      {error && (
        <div className="rounded-xl border border-red-300 bg-red-50 p-6 text-center">
          <p className="text-red-700 font-semibold">Error al cargar notificaciones</p>
