...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Socio de conectividad premium", href: "/socio-premium" },
    ],
  },
];
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 transition border border-gray-600 rounded-lg px-4 py-2"
            >
              ...
              <div className="leading-tight">
                <p className="text-[9px] text-gray-400 uppercase tracking-wide">Disponible en</p>
            ...
            >
              ...
              <div className="leading-tight">
                <p className="text-[9px] text-gray-400 uppercase tracking-wide">Descargar en</p>
